package es.miguel.listadetareas;

/**
 * Created by Miguel on 19/04/2016.
 */
...
public class DataBaseHelper  {
    ...
    //tabla y campos
    public static final String DATABASE_TABLE_TODOLIST="todolist";
    ...
    //SQL creacion de la tabla
    private static final String DATABASE_CREATE_TODOLIST=
            "create tabke "+DATABASE_TABLE_TODOLIST+" ("+ SL_ID+" integer primary key,"+
            SL_ITEM+" text not nul, "+ SL_SPACE+" text not null, " + SL_IMPORTANCE+
